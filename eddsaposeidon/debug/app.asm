...
c0de1262:	b0da      	sub	sp, #360	@ 0x168
...
c0de126e:	f5b0 7f80 	cmp.w	r0, #256	@ 0x100
c0de1272:	d002      	beq.n	c0de127a <handler_get_insecure_public+0x1a>
c0de1274:	5421      	strb	r1, [r4, r0]
c0de1276:	3001      	adds	r0, #1
c0de1278:	e7f9      	b.n	c0de126e <handler_get_insecure_public+0xe>
c0de127a:	f000 f883 	bl	c0de1384 <OUTLINED_FUNCTION_0>
c0de127e:	b9f8      	cbnz	r0, c0de12c0 <handler_get_insecure_public+0x60>
c0de1280:	a804      	add	r0, sp, #16
c0de1282:	f000 f8af 	bl	c0de13e4 <OUTLINED_FUNCTION_11>
c0de1286:	b9d8      	cbnz	r0, c0de12c0 <handler_get_insecure_public+0x60>
c0de1288:	a804      	add	r0, sp, #16
c0de128a:	a901      	add	r1, sp, #4
c0de128c:	f001 f916 	bl	c0de24bc <tEdwards_alloc>
c0de1290:	b9b0      	cbnz	r0, c0de12c0 <handler_get_insecure_public+0x60>
c0de1292:	480e      	ldr	r0, [pc, #56]	@ (c0de12cc <handler_get_insecure_public+0x6c>)
c0de1294:	eb09 0100 	add.w	r1, r9, r0
c0de1298:	a804      	add	r0, sp, #16
c0de129a:	aa01      	add	r2, sp, #4
c0de129c:	f000 fd1c 	bl	c0de1cd8 <zkn_prv2pub>
c0de12a0:	b970      	cbnz	r0, c0de12c0 <handler_get_insecure_public+0x60>
c0de12a2:	a804      	add	r0, sp, #16
c0de12a4:	f104 0320 	add.w	r3, r4, #32
c0de12a8:	a901      	add	r1, sp, #4
c0de12aa:	f000 f886 	bl	c0de13ba <OUTLINED_FUNCTION_7>
c0de12ae:	b938      	cbnz	r0, c0de12c0 <handler_get_insecure_public+0x60>
c0de12b0:	9804      	ldr	r0, [sp, #16]
c0de12b2:	0041      	lsls	r1, r0, #1
c0de12b4:	a81a      	add	r0, sp, #104	@ 0x68
c0de12b6:	f7ff f9e9 	bl	c0de068c <io_send_response_pointer>
c0de12ba:	f005 ff8f 	bl	c0de71dc <cx_bn_unlock>
c0de12be:	b118      	cbz	r0, c0de12c8 <handler_get_insecure_public+0x68>
c0de12c0:	f000 f864 	bl	c0de138c <OUTLINED_FUNCTION_1>
c0de12c4:	b05a      	add	sp, #360	@ 0x168
c0de12c6:	bdb0      	pop	{r4, r5, r7, pc}
c0de12c8:	2000      	movs	r0, #0
c0de12ca:	e7fb      	b.n	c0de12c4 <handler_get_insecure_public+0x64>
